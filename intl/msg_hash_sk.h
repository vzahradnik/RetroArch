...
MSG_HASH(
      ...
      "Zariadené bolo odpojené z portu"
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "Súbor už existuje. Prebieha ukladanie do záložného zásobníka"
      )
MSG_HASH(
      MSG_GOT_CONNECTION_FROM,
      "Bolo vytvorené spojenie s \"%s\""
      )
MSG_HASH(
      MSG_GOT_CONNECTION_FROM_NAME,
      "Bolo vytvorené spojenie s \"%s (%s)\""
      )
MSG_HASH(
      MSG_PUBLIC_ADDRESS,
      "Verejná adresa"
...
MSG_HASH(
      ...
      "Neboli zadané žiadne argumenty a nie je dostupné žiadne menu, zobrazuje sa Pomocník..."
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "Nemáte povolenie hrať túto hru"
      )
MSG_HASH(
      MSG_NETPLAY_CANNOT_PLAY_NO_SLOTS,
      "Už nie sú voľné žiadne voľné miesta pre hráčov"
      )
MSG_HASH(
      MSG_NETPLAY_CANNOT_PLAY_NOT_AVAILABLE,
      "Požadované vstupné zariadenia nie sú k dispozícii"
      )
MSG_HASH(
      MSG_NETPLAY_CANNOT_PLAY,
      "Nie je možné prepnúť sa do herného režimu"
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "Vaša prezývka bola zmenená na \"%s\""
      )
MSG_HASH(
      MENU_ENUM_SUBLABEL_VIDEO_SHARED_CONTEXT,
      "Dá hardvérovo vykresľovaným jadrám ich vlastný privátny kontext. Zabráni sa tak nutnému predpokladu, že sa medzi snímkami zmenil stav hardvéru."
      )
MSG_HASH(
      MENU_ENUM_SUBLABEL_MENU_SETTINGS,
      "Prispôsobí nastavenia vzhľadu obrazovky menu."
      )
MSG_HASH(
      MENU_ENUM_SUBLABEL_VIDEO_HARD_SYNC,
      "Silná synchronizácia medzi procesorom a grafickou kartou. Zníži sa latencia, no je potrebný vyšší výkon."
      )
MSG_HASH(
      MENU_ENUM_SUBLABEL_VIDEO_THREADED,
      "Zlepší výkon, avšak vedie k vyššej latencii a môže spôsobiť problémy s videom. Použite iba vtedy, ak neviete dosiahnuť požadovaný výkon."
      )
MSG_HASH(
      MSG_AUDIO_VOLUME,
      "Hlasitosť zvuku"
...
MSG_HASH(
      ...
      "Prebieha pripájanie k portu"
      )
MSG_HASH(
      MSG_CONNECTION_SLOT,
      "Pozícia pre pripojenie"
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "Pozastaviť achievementy (hardcore režim)"
      )
MSG_HASH(
      MENU_ENUM_LABEL_VALUE_ACHIEVEMENT_RESUME,
      "Pokračovať s achievementami (hardcore režim)"
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "Ovládač zvukového zariadenia"
      )
MSG_HASH(
      MENU_ENUM_LABEL_VALUE_AUDIO_DSP_PLUGIN,
      "Plugin pre zvukové DSP"
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "Výstupná zvuková frekvencia (Hz)"
      )
MSG_HASH(
      MENU_ENUM_LABEL_VALUE_AUDIO_RATE_CONTROL_DELTA,
      "Dynamické ovládanie zvukovej frekvencie"
      )
MSG_HASH(
      MENU_ENUM_LABEL_VALUE_AUDIO_RESAMPLER_DRIVER,
      "Ovládač pre prevzorkovanie zvuku"
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "Úroveň zvukovej hlasitosti (dB)"
      )
MSG_HASH(
      MENU_ENUM_LABEL_VALUE_AUDIO_WASAPI_EXCLUSIVE_MODE,
      "WASAPI režim s výlučným prístupom"
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "Veľkosť zdieľaného WASAPI zásobníka"
      )
MSG_HASH(
      MENU_ENUM_LABEL_VALUE_AUTOSAVE_INTERVAL,
      "Interval pre automatické ukladanie SaveRAM"
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "Automaticky načítať prednastavenia shaderov"
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "URL adresa pre Buildbot assety"
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "Načítať súbor s cheatmi"
      )
MSG_HASH(
      MENU_ENUM_LABEL_VALUE_CHEAT_FILE_SAVE_AS,
      "Uložiť cheat súbor ako"
      )
MSG_HASH(
      MENU_ENUM_LABEL_VALUE_CHEAT_NUM_PASSES,
      "Priepustky pre cheaty"
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "Rebríčky najlepších hráčov"
      )
MSG_HASH(
      MENU_ENUM_LABEL_VALUE_CHEEVOS_BADGES_ENABLE,
      "Odznaky za achievementy"
      )
MSG_HASH(
      MENU_ENUM_LABEL_VALUE_CHEEVOS_LOCKED_ACHIEVEMENTS,
      "Uzamknuté achievementy:"
      )
MSG_HASH(
...
MSG_HASH(
      ...
      "Uložiť konfiguráciu pri skončení"
      )
MSG_HASH(
